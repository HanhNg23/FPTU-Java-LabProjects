...
public class ProductList extends ArrayList<Product> {
    ...
    public void create() {
        ...
        do { //first check Does ID input is repeated or invalid
            productID = MyTool.readPattern("ID of new Product (follow the ID format D[3 number]: ", Product.ID_FORMAT);
        ...
        unitprice = MyTool.readFloatNum("Price (Currency: VND): ");
...
//          update newproductName; 
            do {
                ...
                switch (choice) {
                    case 1:
                        ...
                        break;
                    case 2:
                        newunitprice = MyTool.readFloatNum("Price (Currency: VND): ");
    ...
    public void showCurrentList() {
        if (this.size() == 0) {
            System.out.println("\u001b[33;mEmpty List !\n");
        } else {
            this.sort(this);
