...
public class Panel2DAnimation extends JPanel implements ActionListener{
	...
	public Panel2DAnimation() {
           this.setBackground(Color.green);
           this.setPreferredSize(new Dimension(PANEl_WIDTH, PANEL_HEIGHT));     
	       backgroundImage = new ImageIcon("src/images/insideout.jpeg").getImage();
           image = new ImageIcon("src/images/icons8-babys-room-100.png").getImage();
           image2 = new ImageIcon("src/images/icons8-flying-stork-with-bundle-100.png").getImage();
