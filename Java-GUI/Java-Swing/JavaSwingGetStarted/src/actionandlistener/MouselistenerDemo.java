...
class Frame_Mouselistener extends JFrame implements MouseListener{
	...
	public Frame_Mouselistener() {
		...
		//set Image
		icon1 = new ImageIcon("src/images/child-with-pacifier-100.png");
		icon2 = new ImageIcon("src/images/icons8-babys-room-100.png");
		icon3 = new ImageIcon("src/images/icons8-crib-64.png");
		icon4 = new ImageIcon("src/images/icons8-flying-stork-with-bundle-100.png");
		icon5 = new ImageIcon("src/images/icons8-pacifier-100.png");
