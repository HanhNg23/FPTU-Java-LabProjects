...
public class CDDaoImpl implements CDDao {
    ...
    public void addCD() {
        ...
        if (numOfCD >= MAX) {
            ...
            {
                System.out.println("Enter CD Name by pressing one choice");
            ...
            {
                System.out.println("Enter CD Type by pressing one choice");
    ...
    public void updateCD(CDs CD) {
        ...
        {
            System.out.println("Update CD Name by pressing one choice");
            System.out.println("    Press 1 - Game");
            System.out.println("    Press 2 - Movie");
            System.out.println("    Press 3 - music");
