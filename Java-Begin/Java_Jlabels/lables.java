...
public class lables {
	...
	public static void main(String[] args) {
		ImageIcon image = new ImageIcon("C:\\Users\\HOANGANH\\Documents\\Java\\Java beginning\\Java beginner\\Java_Jlabels\\convoi.png");
...
//	    System.out.println(image.getIconWidth());
		...
		//Setting for label
				...
				label.setForeground(Color.white);//set color for text
